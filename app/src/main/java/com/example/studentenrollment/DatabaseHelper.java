...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertDefaultSubjects(SQLiteDatabase db) {
        ...
        String[] subjects = {
                "Numerical Method", "Network Security", "3D Computer Graphics and Animation", "Computer Science",
                "Data Structure Algorithm", "Software Engineering", "Artificial Intelligence", "France",
                "Wireless and Mobile Programming", "Tennis", "Golf", "Mandarin"
        };
